...
public class CheckUtil {
	 ...
	 * @return
	 */
	public static Boolean checkNumber(String str) { return !isEmpty(str) && str.matches("^\\d+$"); }
...
//	}
	...
	public static final String REGEX_MOBILE = "^0?1(?:[0-9]|[457]|[0-35-9]|[0-35-9])\\d{9}$";	//手机号码只验证1开头，11为数字即可
