...
public class OhMyEmail {
    ...
    private static Properties typeBySSLOrTLS(Boolean debug, String type, String emailType) {
        Properties props = new Properties();
        if (type.equals("SSL")) {
            //SSL方式
            props.put("mail.smtp.host", "smtp." + emailType + ".com");
     ...
     * @return
     */
    public static Properties SMTP_office365(Boolean debug, String type) {
        return typeBySSLOrTLS(debug, type, "office365");
    }
     ...
     *
     * @param debug enable debug
     * @param type  SSL方式、TLS方式
     * @return
     */
    public static Properties SMTP_gmail(Boolean debug, String type) {
        return typeBySSLOrTLS(debug, type, "gmail");
    }
     ...
     * @return
     */
    public static Properties SMTP_sina(Boolean debug) {
        Properties props = defaultConfig(debug);
